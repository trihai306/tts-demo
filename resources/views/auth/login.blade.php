        ...
        <div class="row align-center-center">
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 p-a0">
                <div class="login-slider">
                    <div class="banner-login" style="background-image: url({{asset('shop/images/pic2.jpg')}})">
                        <div class="banner-content">

                            <h4 class="sub-title">Đăng nhập</h4>
                            <h2 class="title">Chào mừng trở lại</h2>
                            <p class="text">Đăng nhập để tiếp tục hành trình khám phá và hoàn thiện mong muốn cùng Vườn An.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xxl-6 col-xl-6 col-lg-6 end-side-content">
                <div class="login-area">
                    <h2 class="login-head mb-1">Đăng nhập</h2>
                    ...
                    <form class="row gx-2">
                        ...
                        <div class="col-xl-6 col-md-12">
                            <button name="submit" value="submit" type="submit" class="btn google-btn w-100">
                                <svg height="22" viewBox="0 0 176 176" width="22" xmlns="http://www.w3.org/2000/svg"><g id="Layer_2" data-name="Layer 2"><g id="_01.facebook" data-name="01.facebook"><circle id="background" cx="88" cy="88" fill="#1877F2" r="88"></circle><path id="icon" d="m115.88 77.58-1.77 15.33a2.87 2.87 0 0 1 -2.82 2.57h-16l-.08 45.45a2.05 2.05 0 0 1 -2 2.07h-16.21a2 2 0 0 1 -2-2.08v-45.44h-12a2.87 2.87 0 0 1 -2.84-2.9l-.06-15.33a2.88 2.88 0 0 1 2.84-2.92h12.06v-14.8c0-17.18 10.2-26.53 25.16-26.53h12.26a2.88 2.88 0 0 1 2.85 2.92v12.9a2.88 2.88 0 0 1 -2.85 2.92h-7.52c-8.13 0-9.71 4-9.71 9.78v12.81h17.87a2.88 2.88 0 0 1 2.82 3.25z" fill="#fff"></path></g></g></svg>
                        ...
                        <div class="col-12">
                            <div class="m-b25">
                                <label class="label-title">Địa chỉ Email</label>
                                <input name="dzName" required="" class="form-control" placeholder="Địa chỉ Email" type="email">
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="m-b10">
                                ...
                                <div class="dz-search-password">
                                    <input name="dzName" required="" class="form-control dz-password" placeholder="Mật khẩu" type="password">
                                    <div class="show-pass">
                        ...
                        <div class="form-row d-flex justify-content-between m-b30">
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="form-check-label" for="basic_checkbox_01">Nhớ cho 30 ngày</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <a class="text-primary btn-border btn-link" href="forget-password.html">Quên mật khẩu</a>
                            </div>
                        </div>
                        <div>
                            <a href="registration.html" class="btn btn-secondary btn-lg w-100 btnhover me-2">Đăng ký</a>
                            <p class="m-t20 fw-light">Bạn không có tài khoản?
                                <a class="register text-primary font-weight-500" href="registration.html">Đăng ký miễn phí</a>
                            </p>
                        </div>
