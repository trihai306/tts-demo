<footer id="footer" class="overflow-hidden">
    <div class="container">
        <div class="row">
            <div class="footer-top-area mt-2">
                <div class="row d-flex flex-wrap justify-content-between">
                    <div class="col-lg-3 col-sm-6 pb-3">
                        <div class="footer-menu">
                            <img src="{{asset('shoplite/images/main-logo.png')}}" alt="logo" class="img-fluid mb-2">
            ...
            <div class="ship-and-payment d-flex gap-md-5 flex-wrap">
                <div class="shipping d-flex">
                    ...
                    <div class="card-wrap ps-2">
                        <img src="{{ asset('shoplite/images/dhl.png') }}" alt="visa">
                        <img src="{{ asset('shoplite/images/shippingcard.png') }}" alt="mastercard">
                    </div>
                </div>
                <div class="payment-method d-flex">
                    <p>Payment options:</p>
                    <div class="card-wrap ps-2">
                        <img src="{{ asset('shoplite/images/visa.jpg') }}" alt="visa">
                        <img src="{{ asset('shoplite/images/mastercard.jpg') }}" alt="mastercard">
                        <img src="{{ asset('shoplite/images/paypal.jpg') }}" alt="paypal">
                    </div>
                </div>
            </div>
            <div class="copyright">
