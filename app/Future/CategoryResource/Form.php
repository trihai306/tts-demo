               ...
               Col::make()->schema([
                    Row::make()->schema([
                        ...
                        Card::make(__('SEO Details'))->schema([
                            Text::make('seo_title')->color('text-primary')->tag('h3'),
                            Text::make('seo_description')->tag('p'),
                            TextInput::make('seo_title')->label(__('Meta Title'))->col(),
                            TextInput::make('slug')->label(__('Slug'))->col(),
                            TextArea::make('seo_description')->label(__('Meta Description'))->col(),
                        ]),
                    ]),
               ])->md('12')->lg('8')->sm('8'),
                Col::make()->schema([
