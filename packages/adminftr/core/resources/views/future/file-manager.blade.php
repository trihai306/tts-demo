                                ...
                                <div class="card-body text-center">
                                    <template x-if="checkFileType(file) === 'Image'">
                                        <div class="card-image" @click="showLinkFile(file)">
                                            <img :src="renderUrl(file)" loading="lazy" width="100" height="100" alt="Hình ảnh" />
                                        </div>
                                    </template>
